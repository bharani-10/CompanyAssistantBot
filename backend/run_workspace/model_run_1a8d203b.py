...
features = ['study_hours', 'attendance_rate', 'previous_scores', 'age', 'gender', 'parental_education', 'internet_access', 'extracurricular_activities']
target = 'final_score'
...
numeric_features = ['study_hours', 'attendance_rate', 'previous_scores', 'age']
